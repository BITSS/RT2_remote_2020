...
2 -  Let's look at some **repos**. [Research](https://www.policyinsights.org), [Comunication](https://github.com/NickCH-K/causalgraphs), [Teaching](http://edrub.in/index.html)   
...
(Suggestion: the "forker" creates the repo, the "forkee" is invited, edits, commits, pushes)  
\pause  
