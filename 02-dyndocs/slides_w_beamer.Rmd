...
author: "| Fernando Hoces \n| BITSS   \n| -\n| Slides at \n|  <https://github.com/BITSS/RT2_remote_2020>\n"
date: "RT2, Remote \n September 2020"
output:
  beamer_presentation:
    fig_caption: no
...
[github.com/BITSS/RT2_DC_2020](https://github.com/BITSS/RT2_DC_2020)
...
## Don't like math? Let's run a simple simulation!   
 1 - Simulate `r format(n.sims.param, big.mark = ",", scientific = FALSE)` rooms with $n = `r n.pers`$ random birthdays, and store the results in matrix where each row represents a room.   
 2 - For each room (row) compute the number of unique birthdays.   
 3 - Compute the average number of times a room has `r n.pers` unique birthdays, across `r format(n.sims.param, big.mark = ",", scientific = FALSE)` simulations, and report the complement.    
...
n.pers.param = n.pers 
sim.prob <- birthday.prob(n.pers.param,n.sims.param); sim.prob
```
...
- And the simulated probability is of  `r sim.prob`
